...
add_url('/data/garden_picture_kind', data.garden_picture_kind, methods=['POST'])
add_url('/data/garden_picture', data.garden_picture, methods=['POST'])
add_url('/data/other_picture', data.other_picture, methods=['POST'])
add_url('/data/building_picture_kind', data.building_picture_kind, methods=['POST'])
add_url('/data/building_picture', data.building_picture, methods=['POST'])
add_url('/data/garden_base_info', data.garden_base_info, methods=['POST'])
add_url('/data/first_floor_kind', data.first_floor_kind, methods=['POST'])
add_url('/data/building_base_info', data.building_info, methods=['POST'])
