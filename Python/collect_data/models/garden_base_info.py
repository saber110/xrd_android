...
class GardenBaseInfo(BaseModel):
    ...
    houseStatus = db.Column(db.Text, default='存量', comment='楼盘状态')
    gardenKind = db.Column(db.Text, default='普通商品房', comment='小区类型')
    ...
    landStatus = db.Column(db.Text, default='国有土地', comment='土地性质')
    right = db.Column(db.Text, default='出让', comment='使用权')
