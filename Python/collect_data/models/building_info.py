...
class BuildingInfo(BaseModel):
    ...
    overheadLayer = db.Column(db.String(1), comment='架空层')
    aboveGroundGarage = db.Column(db.String(1), comment='地上车库')
    utilityRoom = db.Column(db.String(1), comment='杂物间')
    residential = db.Column(db.String(1), comment='住宅')
    shop = db.Column(db.String(1), comment='商铺')
