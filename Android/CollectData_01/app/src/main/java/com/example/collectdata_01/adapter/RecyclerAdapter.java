...
public class RecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case DataBean.CHILD_ITEM1:
                view = mInflater.inflate(R.layout.recycleview_item_child1, parent, false);
                return new ChildViewHolder(context, view);
            case DataBean.CHILD_ITEM2:
                view = mInflater.inflate(R.layout.recycleview_item_child2, parent, false);
                return new ChildViewHolder(context, view);
            case DataBean.CHILD_ITEM3:
                view = mInflater.inflate(R.layout.recycleview_item_child3, parent, false);
                return new ChildViewHolder(context, view);
            case DataBean.CHILD_ITEM4:
                view = mInflater.inflate(R.layout.recycleview_item_child4, parent, false);
                return new ChildViewHolder(context, view);
            default:
                view = mInflater.inflate(R.layout.recycleview_item_parent, parent, false);
                return new ParentViewHolder(context, view);
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        switch (getItemViewType(position)){
            case DataBean.PARENT_ITEM:
                ...
                break;
            case DataBean.CHILD_ITEM1:
                childViewHolder = (ChildViewHolder) holder;
    ...
    private DataBean getChildDataBean(DataBean bean){
        ...
        child.setType(bean.getForChildType(bean));
