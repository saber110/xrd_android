...
public class GetStreetViewAdapter extends RecyclerView.Adapter<GetStreetViewAdapter.ViewHolder> {


    private Context context;
    private LayoutInflater inflater;
    private StreetDao.DataBean dataBean;
    private MyItemClickListener mItemClickListener;

    public GetStreetViewAdapter(Context context, StreetDao.DataBean dataBean) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final StreetDao.DataBean.StreetsBean streetsBean = dataBean.getStreets().get(position);
        holder.locationName.setText(streetsBean.getName());
    }

    @Override
    public int getItemCount() {
        return dataBean.getStreets().size();
    }
