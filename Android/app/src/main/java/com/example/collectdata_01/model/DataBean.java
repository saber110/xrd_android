package com.example.collectdata_01.model;
...
public class DataBean {
    ...
    public static final int CHILD_ITEM1 = 1;//子布局
    public static final int CHILD_ITEM2 = 2;//子布局
    public static final int CHILD_ITEM3 = 3;//子布局
    public static final int CHILD_ITEM4 = 4;//子布局
    ...
    public void setForChildType(int type){
        this.forChildType = type;
    }
    public int getForChildType(DataBean bean){
        return bean.forChildType;
    }
}
